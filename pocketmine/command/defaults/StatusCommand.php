...
class StatusCommand extends VanillaCommand{
	...
	public function __construct($name){
		...
		$this->setPermission("pm.cmd.status");
	}
	...
	public function execute(CommandSender $sender, $currentAlias, array $args){
		...
		$sender->sendMessage(TextFormat::GOLD . "%pocketmine.command.status.Heapocketmineemory " . TextFormat::RED . number_format(round(($rUsage[0] / 1024) / 1024, 2)) . " MB.");
