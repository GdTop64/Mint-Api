<?php
/*
Esto está aquí por el Cmd de Inicio, Y Dejaré Las Funciones x aka si Alguien quiere mantener sus plugins con el formato original.
*/
/*
 *
...
namespace pocketmine {
	...
	if(php_sapi_name() !== "cli"){
		$logger->critical("You must run PM-MP using the CLI.");
		++$errors;
	}
	...
	if(extension_loaded("pocketmine")){
		if(version_compare(phpversion("pocketmine"), "0.0.1") < 0){
			$logger->critical("You have the native PM extension, but your version is lower than 0.0.1.");
			++$errors;
		}elseif(version_compare(phpversion("pocketmine"), "0.0.4") > 0){
			$logger->critical("You have the native PM extension, but your version is higher than 0.0.4.");
			++$errors;
		}
	}
	...
	You are running PM with xdebug enabled. This has a major impact on performance.
	...
	if(\Phar::running(true) === ""){
		$logger->warning("Usando API En Carpeta, No Usar para Producción");
	}
	...
	echo "Server Detenido." . Terminal::$FORMAT_RESET . "\n";
