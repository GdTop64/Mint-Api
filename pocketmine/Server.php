...
use pocketmine\entity\FollowingNPC;
...
use pocketmine\level\generator\Aether;
...
use pocketmine\plugin\JSPluginLoader;
...
private $whitelist = null;
	...
	public function getMotd(){
		return $this->getConfigString("motd", "§b§lTech§9Craft§r§7 | MultiGames");
	}
	...
	* @return refactor
	*/
	public function getRefactor() : refactor{
...
#$this->refactor->refactorial("src", "", "namespace pocketmine");
		$string = TextFormat::AQUA . '  __  __ _       _                       _ 
 |  \/  (_)     | |          /\         (_)
 ...
 |_|  |_|_|_| |_|\__|    /_/    \_\ .__/|_|
                                  | |      
                                  |_|      
§fEs un Fork de PocketMine-MP, Creado para Mejorarlo a Las necesidades nuevas y utiles de un servidor.
	CodeName : §6' . $this->getpocketmineVersion() . '§f
	Version de MCPE: §b' . \pocketmine\MINECRAFT_VERSION . '
  §b Versión de API§f :§e 1.2
	';
    ...
    $this->regs = new Config($this->dataPath . "registrados.yml" , Config::YAML, []);
			...
			if(!extension_loaded("openssl")){
				$this->logger->warning("OpenSSL Sin Cargar Por deprecacion de la API");
...
$eload->searchEcho();
			...
			Generator::addGenerator(Aether::class, "aether");
...
public function comp(){
    ...
    $this->getLogger()->info("§b[Refactor] (server) §7Verificando integridad de plugins.
..");
   
    $this->refactor->refactorial("src", "pocketmine", "pocketmine");
    clearstatcache(); 
    }
	/**
	 * @param int $type
...
// Error CMD 
		$sender->sendMessage($this->getProperty("settings.error-cmd"));
...
*/
	public function reload(){
		$this->logger->info("Guardando Mundos...");
		...
		$this->logger->info("Recargando Plugins...");
	...
	private function registerEntities(){
		...
		Entity::registerEntity(FollowingNPC::class, true);
...
Entity::registerEntity(\milk\pureentities\entity\monster\walking\Zombie::class, true, ["Zombie"]);
Entity::registerEntity(\milk\pureentities\entity\monster\walking\Creeper::class, true, ["Creeper"]);
Entity::registerEntity(\milk\pureentities\entity\animal\walking\Cow::class, true, ["Cow"]);
Entity::registerEntity(\milk\pureentities\entity\animal\walking\Sheep::class, true, ["Sheep"]);
Entity::registerEntity(\milk\pureentities\entity\animal\walking\Pig::class, true, ["Pig"]);
Entity::registerEntity(\milk\pureentities\entity\animal\walking\Chicken::class, true, ["Chicken"]);
Entity::registerEntity(\milk\pureentities\entity\monster\walking\Spider::class, true, ["Spider"]);
Entity::registerEntity(\milk\pureentities\entity\monster\walking\IronGolem::class, true, ["IronGolem"]);
Entity::registerEntity(\milk\pureentities\entity\monster\walking\SnowGolem::class, true, ["SnowGolem"]);
Entity::registerEntity(\milk\pureentities\entity\monster\walking\Skeleton::class, true, ["Skeleton"]);
Entity::registerEntity(\milk\pureentities\entity\monster\walking\PigZombie::class, true, ["PigZombie"]);
